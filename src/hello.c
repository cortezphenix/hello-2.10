...
main (int argc, char *argv[])
{
  ...
  greeting_msg = _("Hello, world! This is the first program which I, Cortez Phenix, have modified the source code. I can't wait to see what the future holds."); /* Even exiting has subtleties.  On exit, if any writes failed, change
